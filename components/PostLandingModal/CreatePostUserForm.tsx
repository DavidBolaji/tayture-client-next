...
interface CreatePostUserFormProps {
  SW: any
}

const CreatePostUserForm: React.FC<CreatePostUserFormProps> = ({ SW }) => {
  ...
  const onSubmit = async (
    ...
    const res = await registerUser({
      ...values,
      path: JSON.stringify(['school admin']),
      skip: true,
    })
...
export default CreatePostUserForm
