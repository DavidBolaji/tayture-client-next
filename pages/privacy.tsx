  ...
  return (
    <div className="">
      <div className="bg-[#fafafa] p-5 w-[500px] mx-auto shadow-lg">
        ...
        <hr className="my-2" />
        <p className="mb-5">
          Welcome to the Tayture&apos;s Privacy Notice (&quot;Notice&quot;).
        </p>
        <p className="mb-3">
          Tayture (&quot;We&quot; or &quot;Our&quot;) operates www.tayture.com (the &quot;Website&quot;) and
          Tayture Mobile Application (the &quot;Application&quot;). The Website and
          Application are platforms built to host, manage, and deploy products
          and services to be consumed by school, teachers and parents for the
          purpose of supporting their effectiveness and professional development
        </p>
        <p className="mb-3">
          This page informs you of Our policies regarding the collection, use
          and disclosure of your personal data when you visit, access, browse
          through and/or use Our Website or Mobile Application (“Platform”) and
          when you use any storage or transmitting device provided by us. Please
          read carefully, as it&apos;s important for you to understand how We intend
          to retain and protect the private information you provide us. To
          protect your privacy, Tayture follows different principles in
          accordance with worldwide practices for user privacy and data
          protection.
        </p>
        <p className="mb-3">
          Tayture values your trust and confidence. We are committed to
          safeguarding the privacy of your information at all times. If you have
          any questions about this Notice or Our data protection practices,
          kindly contact us.
        </p>
        ...
        <p className="mb-3">
          ...
          <br />
          Full name of legal entity: Tayture Limited
          <br />
          Email address:hello@tayture.com
        </p>
        <h2>Consent</h2>
        <p className="mb-3">
          By accessing or using Our services or Products, you agree to the
          collection and use of information in accordance with this Notice. Once
          you provide consent, you may change your mind and withdraw the consent
          at any time by contacting us at hello@tayture.com, but please note
          that consent withdrawal will not affect the lawfulness of any
        ...
        <p className="mb-3">
          ...
          mailing address, location, profession, age, professional experience,
          picture and phone number; Financial data, such as your card
          information, billing address, and payment options may also be required
          by our payment service providers; Technical information, such as the
          type of mobile device and internet browser you use, your computer IP
          address, data about the pages you access, mobile device ID or unique
          identifier, statistics on page views, standard Web log data, still and
          moving images, etc; Marketing data, such as users&apos; feedback; and Usage
          data, such as time spent on Our application, when application was
          opened, device data and learning statistics (time spent learning,
          lessons viewed, test scores, etc.).
        </p>
        <h2>How We Use Your Personal Data</h2>
        <p>
          We will only use your personal data for the purpose for which We
          collected it which may include the following:
        </p>
        <p>
          ...
          <br />
          to help us identify and provide the type of service offerings in which
          you are most interested in
          <br />
          to enable us create the content most relevant to you and to generally
          improve Our services
          <br />
          to make the Platform easier for you to use by not having to enter
          information more than once
          <br />
          to manage risk, or to detect, prevent, and/or remediate fraud or other
          potentially prohibited or illegal activities
          <br /> and to send periodic emails and marketing materials regarding
        ...
        <p className="mb-3">
          ...
          you to review these privacy policies – because this Notice will not
        ...
        <h2>Cookies</h2>
        <p className="mb-3">
          Our Website uses cookies (small files containing a string of
          characters), which We place on your computer, if you agree. These
          cookies allow us to uniquely identify your browser and to distinguish
          you from other users of Our Website. This enables us to track your
          preferences and provide you with a personalized and smooth experience
          when you browse Our Website. The cookies We use are “analytical”
          cookies. They allow us to recognize and count the number of visitors
          and to see how visitors move around the Website when they are using
          it. This helps us to improve the way Our Website works, for example by
          ensuring that users are finding what they are looking for easily. We
          do not share the information the cookies collect with any third
          parties.
        </p>
        <h2>User Profiles</h2>
        <p className="mb-3">
          Every registered user has a unique personal profile. Each profile is
          accessed via a unique email address which helps us ensure that only
        ...
        <p className="mb-3">
          ...
          identification number back to your email address with an activation
          link for the activation of your profile. This code is uniquely yours.
          It is your passport to seamless travel across Our Platform, allowing
          you to use Our Platform without having to fill out registration forms
          with information you&apos;ve already provided. Even if you switch
          computers, you won&apos;t have to re-register – just use your User ID to
          identify yourself.
        </p>
        <h2>Data Security</h2>
        <p className="mb-3">
          ...
          a country must have an adequate data protection law. Please be assured
          that We have put in place appropriate security measures including but
          not limited to access controls, firewalls, data encryption, and
          physical security to prevent your personal data from being lost,
          altered, disclosed, or otherwise used in an unauthorized way. In
          addition, We limit access to your personal data to those employees,
          agents and contractors who have a business need to know. These
          employees, agents, and contractors have a duty to maintain
          confidentiality at all times and will only process your personal data
          according to Our instructions.
        </p>
        <p className="mb-3">
          Also note that We have put in place procedures to deal with any
        ...
        <p>
          ...
          personal information We hold about you and check that We are lawfully
          processing it. Please note that a data subject access request may
          attract an administrative fee; request correction of the personal data
          ...
          <br /> request erasure of your personal data. This enables you to ask
          ...
          <br /> object to processing of your personal data where We are relying
          ...
          rights and freedoms;
          <br /> request the transfer of your personal data to you or to a third
          party. We will provide you, or a third party you have chosen, your
          ...
          <br /> withdraw consent at any time where We are relying on consent to
        ...
        <h2>Security</h2>
        <p className="mb-3">
          At Tayture, We implement a variety of reasonable security measures to
        ...
        <p className="mb-3">
          ...
          (SSL/TLS) to ensure secure transmission of your personal data. You
          should see the padlock symbol in your URL address bar once you are
        ...
        <h2>Online Privacy Notice Only</h2>
        <p className="mb-3">
          This online Notice applies only to information collected on Our
          Platform and not to information collected offline.
        </p>
        <h2>Changes to Our Privacy Policy</h2>
        <p className="mb-3">
          We reserve the right to amend or modify this Privacy Policy and if We
          do so, We will post the changes on this page. It is your
          responsibility to check the Privacy Policy every time you submit
          information to us or use Our services. Your use will signify that you
          agree to any such changes. In the event the purpose is for processing
          change, or if a revision is material, Tayture will notify you via
        ...
        <p className="mb-3">
          ...
          of information contained on Our Platform—particularly those shared by
          third party users.
        </p>
        <p>
          Contact Us
